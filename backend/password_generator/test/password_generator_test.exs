defmodule PasswordGeneratorTest do
  ...
  test "returns error when lenght is not an integer" do
    options = %{"length" => "ab"}
  ...
  test "reuturns error when 1 option not allowed" do
  ...
  test "returns string uppercase", %{options_type: options} do
    ...
    {:ok, result} = PasswordGenerator.generate(optiions_with_uppercase)
  ...
  test "returns string just with numbers", %{options_type: options} do
    ...
    {:ok, result} = PasswordGenerator.generate(optiions_with_numbers)
  ...
  test "returns string with uppercase and numbers", %{options_type: options} do
    ...
    {:ok, result} = PasswordGenerator.generate(optiions_included)
